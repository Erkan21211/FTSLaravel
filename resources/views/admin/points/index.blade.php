            ...
            <div class="overflow-x-auto">
                <table class="w-full text-gray-800 border-collapse">
                    ...
                    <tr class="bg-gray-700 text-gray-300">
                        ...
                        <th class="border-b border-gray-600 p-4 text-left">Huidige Punten</th>
                    ...
                    @foreach ($customers as $customer)
                        <tr>
                            <td class="border-b border-gray-300 p-4 text-white">
                                {{ $customer->first_name . ' ' . $customer->last_name }}
                            </td>
                            <td class="border-b border-gray-300 p-4 text-white">{{ $customer->email }}</td>
                            <td class="border-b border-gray-300 p-4 text-white">{{ $customer->points }}</td>
