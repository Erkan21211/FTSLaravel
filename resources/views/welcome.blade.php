<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        <div class="bg-white shadow-md rounded-lg p-6 text-center">
            <h1 class="text-2xl font-bold mb-4">WELKOM BIJ Festival Travel System</h1>
            <p class="text-gray-600 mb-6">Plan je reis en geniet van een zorgeloze festivalervaring. Ontdek reizen en beheer je boekingen eenvoudig!</p>
